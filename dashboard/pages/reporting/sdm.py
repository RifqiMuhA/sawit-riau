...
def update_kpi(pid):
    ...
    return dbc.Row([
        dbc.Col(_kpi(str(k["total"]),    "Total Karyawan",    "👥", ""),       lg=4, md=4, sm=12, className="mb-2"),
        dbc.Col(_kpi(str(k["aktif"]),    "Karyawan Aktif",    "✅", ""),       lg=4, md=4, sm=12, className="mb-2"),
        dbc.Col(_kpi(pct_aktif,          "Tingkat Keaktifan", "📊", "info"),   lg=4, md=4, sm=12, className="mb-2"),
    ], className="g-3")
